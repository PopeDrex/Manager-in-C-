...
working exe in v0.1 folder.. 

keep files in folder together or it wont't start, it will create a file called "data" always keep this with the program since this is where it stores all needed.
